...
try {
  ...
  if($nginxResults.Count -ne 30 -or @($nginxResults.Values|Where-Object{$_ -ne 'PASS'}).Count -ne 0){throw 'NGX fixture matrix incomplete'}
  Write-Output '[deployment-windows] PASS (ACL-P1..ACL-P8, PATH-P1..PATH-P3, SB-P1..SB-P14, RPT-P1..RPT-P9, NGX-P1..NGX-P30, preflight isolation, SSH host-key/firewall, exact psql, privacy, safe-stop, migration and transfer fixtures)'
} finally {
