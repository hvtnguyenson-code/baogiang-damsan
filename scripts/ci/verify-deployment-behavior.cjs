...
assert.match(restart, /AllowScheduledTaskActivation/); assert.match(restart, /Stop-ExactBaoGiangRuntime/); assert.ok(restart.indexOf('Enable-ScheduledTask') < restart.indexOf('Start-ScheduledTask'));
