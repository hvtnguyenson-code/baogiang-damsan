...
assert.ok(remoteSource.indexOf('HANDSHAKE_COMMON_HASH_MISMATCH') < remoteSource.indexOf('. $common')); assert.ok(remoteSource.indexOf('Read-DeploymentIdentity') < remoteSource.indexOf('New-Item -ItemType Directory'));
