...
export type TimetableImportPreviewIssueCode =
  ...
  | 'TKB_NATIVE_SHEET_STRUCTURE_INVALID'
  | 'TKB_NATIVE_HEADER_INVALID'
  | 'TKB_NATIVE_EFFECTIVE_DATE_MISSING'
  | 'TKB_NATIVE_EFFECTIVE_DATE_MISMATCH'
  | 'TKB_NATIVE_CLASS_HEADER_UNKNOWN'
  | 'TKB_NATIVE_MARKER_SYNTAX_INVALID'
  | 'TKB_NATIVE_PEER_MISSING'
  | 'TKB_NATIVE_PEER_DUPLICATE'
  | 'TKB_NATIVE_PEER_ORPHAN'
  ...
  | 'TKB_NATIVE_CARRY_FORWARD_PROVENANCE_INVALID';
