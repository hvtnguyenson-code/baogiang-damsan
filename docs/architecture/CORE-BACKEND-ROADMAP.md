...
3. **Delayed go-live operational-start policy** — explicit start authority without inventing historical debt (`P1-030` CLOSED by `SYNC-P1-030`, `ADR-049` Accepted; `P1-031` IN_REVIEW; `P1-032` PLANNED).
...
└── P2-001 (Curricular component architecture, CLOSED by SYNC-P2-001, ADR-048 Accepted)
    ...
    │   └── P1-031 (Operational-start policy, IN_REVIEW)
