...
└── P2-001 (Curricular component architecture, CLOSED by SYNC-P2-001, ADR-048 Accepted)
    ...
    │       │       └── P1-032 (Operational-start admin UI, PLANNED; depends on P1-022 + P1-031A + P1-031C)
    │       └── P1-031C (Academic-Year options read model, READY; depends on P1-021 + P1-031)
