...
Trước UI task phải đọc `.codex/skills/damsan-ui/SKILL.md` và `DESIGN.md` đầy đủ. UI không được invent business semantics hay authorization. Backend/current product authority phải đóng trước khi UI chốt workflow tương ứng. `P1-032` chưa đủ dependency: P1-031B đã CLOSED, nhưng P1-032 chỉ được bắt đầu sau P1-031A merge/post-merge CI và `SYNC-P1-031A`; khi đó vẫn phải tuân thủ UI skill/design authority và không suy diễn semantics ngoài ADR-049/P1-031/P1-031B/P1-031A.
