...
Trước UI task phải đọc `.codex/skills/damsan-ui/SKILL.md` và `DESIGN.md` đầy đủ. UI không được invent business semantics hay authorization. Backend/current product authority phải đóng trước khi UI chốt workflow tương ứng. `P1-032` phụ thuộc bổ sung `P1-031C` (trạng thái `PLANNED`); khi P1-031C đóng và P1-032 bắt đầu vẫn phải tuân thủ UI skill/design authority và không suy diễn semantics ngoài ADR-049/P1-031/P1-031B/P1-031A.
