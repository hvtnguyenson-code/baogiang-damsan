...
- PPCT occurrence allocation đã được triển khai runtime component-aware: P2-003 đã **CLOSED** bởi `SYNC-P2-003` (định tuyến cơ hội tuần, tiến độ độc lập và chiếu báo cáo kết hợp); P2-004 admin applicability workspace là downstream UI tiếp theo ở trạng thái **READY**;
