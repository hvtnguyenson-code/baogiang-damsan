...
| `P2-002` PPCT component persistence + control-plane realignment | `IN_REVIEW` | `P2-001` | Schema migration for component model and applicability, version control plane, CAS/Serializable concurrency, backward-compatible migration preserving retained history, server-side calendar week-split prevention, and read contracts on dedicated branch `feat/ppct-component-persistence-control-plane-002` (starting base: `0594bbab58bf49a058ab4a744499366f3acbaf78`). Downstream boundary preserved component-free. Awaiting independent GitHub review. | T45, T46 |
