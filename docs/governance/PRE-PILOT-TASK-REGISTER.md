...
| `P2-004` Specialized-study class-subject administration workspace | `READY` | `P2-003` | Capability-gated administrative UI for managing class-subject specialized-study applicability with effectivity and audit trails | T45, T46 |
