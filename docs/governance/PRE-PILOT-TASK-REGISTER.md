...
| `P1-031` Operational-start policy implementation | `READY` | `P1-021`, `P1-030`, `P2-003` | Typed/versioned policy runtime and read authority using Business Configuration foundation | T28, T30 |
