...
| `P1-012` Homeroom control plane | `IN_REVIEW` | `P1-011` | Capability-controlled create/change/end/correct/read/resolve, same-transaction audit, bounded SERIALIZABLE conflict handling, retained historical resolution and command-layer regression for correction lineage; branch evidence: lint/typecheck/unit/build/schema static/Prisma validate PASS, isolated PostgreSQL integration NOT RUN / BỊ CHẶN DO MÔI TRƯỜNG; pending independent review and exact-head CI | T13, T14 |
