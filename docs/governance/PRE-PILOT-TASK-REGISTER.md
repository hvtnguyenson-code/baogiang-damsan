...
| `P1-013` Homeroom administration workspace | `IN_REVIEW` | `P1-012A` | Bounded admin/PHT UI using frozen backend contracts; no UI-invented authority | T13, T14; branch `feat/homeroom-administration-workspace-013`; canonical start `3f8a1763991cc53c9767638ba380aff7ce66e4f2`; local lint/typecheck/targeted tests/build recorded, independent review and exact-head CI pending |
