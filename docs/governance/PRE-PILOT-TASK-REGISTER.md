...
| `P2-003` Component-aware PPCT allocation and curricular projections | `IN_REVIEW` | `P2-002` | Deterministic component-aware weekly routing allocator, independent progression coverage, progress/debt/late projection realignment, and execution/report provenance. Dedicated branch `feat/ppct-component-aware-allocation-projections-003`; local candidate implementation complete at `dd3463b8108a712a85d42fd56f04b6460126bef2` across 7 commits (`d34fec7`..`dd3463b`); full local validation complete (targeted tests, full API unit 1162/1162, web unit 236/236, full API integration 333/333 suites, monorepo lint, typecheck, build, static security/deployment gates, Windows deployment, capability catalog integration, Playwright smoke 12/12, npm audit high/critical 0, migration CI/replay, git diff --check); zero schema/migration changes; pending remote branch push, PR, exact-head PR CI, independent GitHub review, merge and authoritative post-merge CI | T45, T46 |
