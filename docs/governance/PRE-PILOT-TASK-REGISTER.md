...
| `P1-012A` Homeroom historical identity read-model correction | `IN_PROGRESS` | `P1-012` | Homeroom-capability-scoped bounded historical User identity discovery plus server-owned business-date read model required by P1-013; no new GVCN authority and no `USER_MANAGE` dependency | T13, T14 |
