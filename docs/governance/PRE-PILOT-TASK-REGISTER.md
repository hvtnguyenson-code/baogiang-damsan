...
| `P2-040` Đam San TKB native adapter implementation | `IN_PROGRESS` | `P2-030` | Native adapter on top of canonical importer; class/teacher peer cross-check; fail-closed mismatch | T25, T26; implement accepted ADR-047/P2-030 contract only; active branch `feat/tkb-native-adapter-040` |
