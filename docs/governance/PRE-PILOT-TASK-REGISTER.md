...
| `P1-022` Business Configuration administration workspace | `READY` | `P1-021` | PHT/admin UI for approved business policy only; no access to secrets/TLS/database/process settings | T21, T22 |
