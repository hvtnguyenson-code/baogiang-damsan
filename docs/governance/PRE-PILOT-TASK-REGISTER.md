...
| Task | Status | Depends on | Deliverable / closure | Traceability |
|---|---|---|---|---|
| `P1-030` Delayed go-live / operational-start architecture | `CLOSED` | `P1-020`, `P2-001` | Dedicated task branch `docs/delayed-go-live-operational-start-architecture-030`; starting canonical main `fafd104c9af5b83833b8a6f324021cea226ffe63`; final reviewed head `c807d26a6a53609ac5259384661db52271460053`; independent GitHub architecture review PASS after bounded forward corrections; PR #131; exact-head PR CI #435 (run `34707601649`) SUCCESS; merge/main `c4ce704a67fab8e24e5bae3ac2ce81dbcb36c27d`; authoritative post-merge main CI #436 (run `34728703082`) SUCCESS; accepted architecture `ADR-049`; parent closed by `SYNC-P1-030`; strictly docs-only scope under `docs/**`, zero runtime/schema/migration/UI/deploy mutation; no correction or re-entry task emerged; production remains PRE-OPERATIONAL; unlocks `P1-031` (`READY`) | T28, T30 |
| `P1-031` Operational-start policy implementation | `IN_PROGRESS` | `P1-021`, `P1-030`, `P2-003` | Dedicated task branch `feat/operational-start-policy-implementation-031`; starting canonical base `13a87538b38312a2dfb482c358b17ac23f4b2ee8`; implementing accepted `ADR-049` (`OPERATIONAL_START` / `v1` / `ACADEMIC_YEAR`), lifecycle enforcement (no RETIRE, prospective REPLACE, post-boundary CORRECTION), typed resolver, progress/debt pre-op exclusion, ordinary execution gates, and ReportingStatement frozen provenance | T28, T30 |
