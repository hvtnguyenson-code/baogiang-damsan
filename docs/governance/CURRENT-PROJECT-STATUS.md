...
Next preferred task:
- `P4-073` — GDĐP workbook importer — is **IN_REVIEW** on dedicated branch `feat/gddp-workbook-importer-073` (implementation complete, full 23-item regression matrix passed, zero-mutation preview verified, fail-closed exact collapse implemented, awaiting independent GitHub review).
