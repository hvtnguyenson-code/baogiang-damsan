...
export function DutyAssignmentsPage() {
  ...
  return <div className="management-page duty-ledger">
    ...
    <div className="filter-bar">
      ...
      <SelectField label="Phạm vi" id="duty-filter-scope" value={filters.scopeType} onChange={(event) => updateFilter('scopeType', event.target.value)}><option value="">Tất cả</option>{schoolWide && <option value="SCHOOL_WIDE">Toàn trường</option>}<option value="SUBJECT_GROUP">Tổ chuyên môn</option></SelectField>
