...
@Module({
  ...
  providers: [
    ...
    { provide: REPORTING_STATEMENT_CLOCK, useClass: SystemReportingStatementClock },
  ],
  exports: [ReportingStatementsService],
})
